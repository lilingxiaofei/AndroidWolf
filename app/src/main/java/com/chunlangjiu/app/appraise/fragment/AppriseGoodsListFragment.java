...
import com.chunlangjiu.app.appraise.activity.AppraiserInfoActivity;
...
public class AppriseGoodsListFragment extends BaseFragment {
    ...
    public static AppriseGoodsListFragment newInstance(String status) {
    ...
    public void initView() {
        ...
        appraiseGoodsAdapter = new AppraiseGoodsAdapter(activity,pageUtils.getList());
        appraiseGoodsAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                AppraiseGoodsBean appraiseBean= appraiseGoodsAdapter.getItem(position);
                    AppraiserInfoActivity.startAppraiserInfoActivity(activity,"");
            }
        });
    ...
    private void getAppraiseGoodsList(int page) {
        ...
        disposable.add(ApiUtils.getInstance().getAppraiseGoodsList(tempStatus,page,10, UserFragment.userType+"")
