...
public class Rotate3dAnimation extends Animation {
    ...
    private static Rotate3dAnimation rotate3dAnimationX ;
    private static Rotate3dAnimation rotate3dAnimationY ;
    private static Rotate3dAnimation rotate3dAnimationZ ;

    // 以X轴为轴心旋转
    public static void rotateOnXCoordinate(View view) {
        float centerX = view.getWidth() / 2.0f;
        float centerY = view.getHeight() / 2.0f;
        float depthZ = 0f;
        if(rotate3dAnimationX==null){
            rotate3dAnimationX =  new Rotate3dAnimation(0, 180, centerX, centerY, depthZ, Rotate3dAnimation.ROTATE_X_AXIS, true);
    ...
    // 以Y轴为轴心旋转
    public static void rotateOnYCoordinate(View mRotateImgv) {
        float centerX = mRotateImgv.getWidth() / 2.0f;
        float centerY = mRotateImgv.getHeight() / 2.0f;
        float centerZ = 0f;
        if(rotate3dAnimationY==null){
            rotate3dAnimationY = new Rotate3dAnimation(0, 90, centerX, centerY, centerZ, Rotate3dAnimation.ROTATE_Y_AXIS, true);
            rotate3dAnimationY.setDuration(1000);
        }
        mRotateImgv.startAnimation(rotate3dAnimationY);
    }

    // 以Z轴为轴心旋转---等价于普通平面旋转动画
    public static void rotateAnimHorizon(View mRotateImgv) {
        float centerX = mRotateImgv.getWidth() / 2.0f;
        float centerY = mRotateImgv.getHeight() / 2.0f;
        float centerZ = 0f;
        if(rotate3dAnimationZ==null){
            rotate3dAnimationZ = new Rotate3dAnimation(180, 0, centerX, centerY, centerZ, Rotate3dAnimation.ROTATE_Z_AXIS, true);
            rotate3dAnimationZ.setDuration(1000);
        }
        mRotateImgv.startAnimation(rotate3dAnimationZ);
