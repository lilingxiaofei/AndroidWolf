 ...
 * @Describe:
 */
public class AuctionConfirmOrderActivityOld extends BaseActivity {
    ...
    public static void startConfirmOrderActivity(Activity activity, GoodsDetailBean goodsDetailBean) {
        Intent intent = new Intent(activity, AuctionConfirmOrderActivityOld.class);
...
//        }
        ...
        public void handleMessage(Message msg) {
            if (msg.what == SDK_PAY_FLAG) {
                ...
                if (TextUtils.equals(resultStatus, "9000")) {
                    ...
                    Toast.makeText(AuctionConfirmOrderActivityOld.this, "支付成功", Toast.LENGTH_SHORT).show();
                    toOrderMainActivity(true);
                    finish();
                } else {
                    // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                    Toast.makeText(AuctionConfirmOrderActivityOld.this, "支付失败", Toast.LENGTH_SHORT).show();
    ...
    private void invokeZhifubaoPay(ResultBean data) {
        ...
        Runnable payRunnable = new Runnable() {
            @Override
            public void run() {
                PayTask alipay = new PayTask(AuctionConfirmOrderActivityOld.this);
